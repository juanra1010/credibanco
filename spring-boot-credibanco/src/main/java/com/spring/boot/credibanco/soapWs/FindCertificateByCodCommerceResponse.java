...
/**
 * <p>Clase Java para findCertificateByCodCommerceResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="findCertificateByCodCommerceResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "findCertificateByCodCommerceResponse", propOrder = {
    "_return"
})
public class FindCertificateByCodCommerceResponse {
